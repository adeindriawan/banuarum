...
<head>
    ...
    <title>BanuArum | Indonesia's Signature Tea</title>
...
<body>
    ...
    <nav class="navbar navbar-dark navbar-fixed-top scrolling-navbar">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-toggleable-xs" id="collapseEx">
                <!--Navbar Brand-->
                <a class="navbar-brand" href="/">BanuArum</a>
                <!--Links-->
    ...
    <div class="view hm-black-strong">
        <div class="full-bg-img flex-center">
            <ul>
                <li>
                    <h1 class="h1-responsive wow fadeInDown" data-wow-delay="0.2s">BanuArum is here!</h1></li>
                <li>
                    <p class="wow fadeInDown">The collection of Indonesia's finest tea.</p>
                </li>
                <li>
    ...
    <div class="container">
        ...
        <div class="divider-new">
            <h2 class="h2-responsive wow fadeInDown">Shop</h2>
        </div>
        ...
        <div class="divider-new">
            <h2 class="h2-responsive wow fadeInUp">Blog</h2>
        </div>
